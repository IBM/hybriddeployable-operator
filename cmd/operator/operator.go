...
import (
	...
	"github.com/IBM/hybriddeployable-operator/pkg/apis"
	"github.com/IBM/hybriddeployable-operator/pkg/controller"
	"github.com/IBM/hybriddeployable-operator/version"
...
func RunManager(sig <-chan struct{}) {
	...
	err = leader.Become(ctx, "hybriddeployable-operator-lock")
	if err != nil {
		klog.Error(err, "")
		os.Exit(errorExitCode)
	}
